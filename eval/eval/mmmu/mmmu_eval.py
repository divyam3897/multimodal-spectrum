...
def eval_model(args):
    ...
    with open(chunk_file, "w") as ans_file:
        ...
        if not args.image_shuffle and not args.text_shuffle:
            plot_category_dist(questions, f"Category Distribution (MMMU Dataset)", os.path.join(plot_dir, f"category_distribution{shuffle_suffix}.png"), all_categories)
        ...
        with torch.inference_mode():
            ...
            if example_num < 3:
                ...
                # MODIFIED LINE: Added the question ID to the main title
